                    ...
                    <div class="col-md-12">
                        ...
                        <nav class="navbar mega-menu">
                            ...
                            <div class="header-right">
                                <div class="social-icons">
                                    ...
                                    <a href="https://x.com/prismtribune?s=21&t=lHyHeLDt-9jfvOkkM_sPHA"
                                        data-toggle="tooltip" data-placement="bottom" title="Twitter"><i
                                            class="fa fa-twitter fa-lg"></i></a>
                                    <a href="https://www.instagram.com/prismtribune?igsh=MWNrcWhrM3U0azUwNg=="
                        ...
                        <div id="sb-search" class="sb-search">
                            <form action="{{ route('blog.posts.search') }}">
                                ...
                                <span class="sb-icon-search fa fa-search" data-toggle="tooltip" data-placement="bottom"
                                    title="Search"></span>
                            </form>
                        </div><!-- .sb-search -->
                    </div>
